    ...
    <div className="bg-[#232323] min-h-screen font-sans">
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center w-full">
          ...
          <Link to="/register">
            <button className="bg-[#D4AF37] hover:bg-[#bfa22e] text-[#232323] font-semibold px-8 py-3 rounded-full shadow-lg transition">
              {t("join_us") || "Join Us"}
            </button>
          </Link>
        </div>
      ...
      <section className="bg-[#F7F7F7] py-16">
        <div className="max-w-5xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-serif font-bold text-[#232323] mb-4">
          ...
          <div className="flex justify-center">
            <img
              src={heroImg}
              alt="Folklore Group"
              className="rounded-2xl shadow-lg w-full max-w-sm object-cover border-4 border-[#D4AF37]"
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="max-w-5xl mx-auto px-4">
          <h3 className="text-2xl font-serif font-bold text-[#232323] mb-8 text-center">
            {t("upcoming_events") || "Upcoming Events"}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Example Event Card */}
            <div className="bg-[#F7F7F7] rounded-xl shadow p-6 flex flex-col">
              ...
              <Link to="/events" className="mt-auto">
                <button className="bg-[#D4AF37] text-[#232323] px-4 py-2 rounded-full hover:bg-[#bfa22e] transition">
      ...
      <section className="bg-[#F7F7F7] py-16">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {/* Example images */}
            <img src={heroImg} alt="Gallery" className="rounded-xl shadow-lg object-cover h-40 w-full" />
            {/* ...more images */}
          </div>
          <Link to="/gallery">
            <button className="mt-8 bg-[#D4AF37] text-[#232323] px-6 py-2 rounded-full hover:bg-[#bfa22e] transition shadow-lg">
      ...
      <section className="bg-[#232323] py-16 text-white">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-6">
            <p>
              <FaEnvelope className="inline-block mr-2 text-[#D4AF37]" /> info@almadabeiraalta.com
            </p>
            <p>
              <FaPhone className="inline-block mr-2 text-[#D4AF37]" /> +352 123 456 789
            </p>
          </div>
          <div className="flex justify-center gap-8 mt-4">
            <a href="https://www.facebook.com/yourpage" target="_blank" rel="noopener noreferrer">
              <FaFacebook size={32} className="hover:text-[#D4AF37] transition" />
            </a>
            <a href="https://www.instagram.com/yourprofile" target="_blank" rel="noopener noreferrer">
              <FaInstagram size={32} className="hover:text-[#D4AF37] transition" />
            </a>
            <a href="https://www.youtube.com/channel/yourchannel" target="_blank" rel="noopener noreferrer">
              <FaYoutube size={32} className="hover:text-[#D4AF37] transition" />
            </a>
            <a href="https://www.tiktok.com/@yourprofile" target="_blank" rel="noopener noreferrer">
              <FaTiktok size={32} className="hover:text-[#D4AF37] transition" />
            </a>
          </div>
        </div>
      </section>
