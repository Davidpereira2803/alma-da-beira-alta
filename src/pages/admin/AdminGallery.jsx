  ...
  return (
    <div className="page-safe-top min-h-screen bg-[#F1F0E4]">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-serif font-bold text-[#3E3F29] mb-2">{t("manage_gallery")}</h1>
        <p className="text-[#7D8D86] mb-3 py-5">
          {t("manage_gallery_hint") || "Add, edit or remove images displayed on the Gallery page."}
        </p>
